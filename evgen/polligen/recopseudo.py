...
# tagged sample -- the fixed 0.05-0.25 window of run 13 discarded 62-73%
# of it -- and they nearly halve the combined one-year delta(a_e),
# 0.00207 -> 0.00121 at 5 x 40.8.  The window stops at 0.017 rather than
# at the aperture floor (|t|_min = 0.0079 / 0.0132 / 0.0094 GeV^2 at the
# tagging optics of the three configurations): a 0.006-0.017 bin has 8-16
# of its 24 beta cells hard empty, a condition number of 12.8-47.3 against
# 1.9-10.9 in the published bins, and a -43 to -273% a_t sensitivity to a
...
# and resolution puts the 0.05-0.08 bin's t_ref at 0.046 -- so the
