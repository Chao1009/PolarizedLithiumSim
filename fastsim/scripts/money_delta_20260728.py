...
Output (12 PNGs):
  ...
  TOP case 1 φ-bin-width scan (4 plots):
...
def main():
    ...
    with r_override(r1998):
        for cfg, config_tag, config_label in all_configs:
            ...
            if config_tag == "top":
                ...
                print()
                print(f"  → TOP config, Case 1: scanning φ bin widths {{5°, 10°, 20°, 30°}}")
                for bin_deg in [5, 10, 20, 30]:
    ...
    # 4 TOP+peakbin bin-width scan plots
    for bin_deg in [5, 10, 20, 30]:
