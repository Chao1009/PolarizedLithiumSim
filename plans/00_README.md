...
| [10_beam_divergence_light_ions.md](10_beam_divergence_light_ions.md) | **The beam divergence the whole far-forward programme rests on** (2026-08-27): every far-forward acceptance is exp(−B(10σ_θ·A·p_u)²), and σ_θ is one energy-independent, isotropic, proton-derived number. YR Table 8.9's e+Au rows are 2.5–3.8× larger and span ×47 between cooling scenarios — a factor 553 at 5 × 41 and fourteen orders at 10 × 100 in the coherent tag. Scaling the YR's own Tables 10.1/10.2 by sqrt(A/Z), with the equal-emittance assumption calibrated against gold, estimates 310/535, 254/254 and 92/92 urad for 6Li at 20.5/50/137.5 GeV/u against the repo's 72.7 — costing three to four orders in the coherent tag |
