...
| u₁, u₂ y-factors and bounds | Nikolaev–Pronyaev–Zakharov Eq. (1); ZEUS NPB 816:1 Sec. 10.2 | `money_cos2phi_coherent_reco.py` defaults | consistent in the values; the defaults are u₁ = the central A_LT at 0.01 < x_P < 0.1 and u₂ within one error of zero, not a 1σ edge (corrected 2026-09-02) |
